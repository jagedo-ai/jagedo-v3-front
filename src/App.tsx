...
const AdminReports = React.lazy(
  () => import("@/pages/dashboard/admin/reports"),
);
        ...
        <CartProvider>
          <Suspense fallback={<RouteLoading />}>
            <Routes>
              ...
              <Route path="/reset-password" element={<ResetToken />} />

              {/* SIGN UP ROUTES */}
              <Route path="/signup/customer" element={<CustomerSignup />} />
              <Route path="/signup/fundi" element={<FundiSignup />} />
              <Route path="/signup/contractor" element={<ContractorSignup />} />
              <Route path="/signup/hardware" element={<HardwareSignup />} />
              <Route
              ...
              <Route element={<ProtectedRoutesLayout />}>
                ...
                <Route element={<ProtectedRoute allowedRoles={["CUSTOMER"]} />}>
                  ...
                  <Route path="/customer/hardware_shop" element={<ShopApp />} />
                  <Route
                  ...
                  <Route
                    ...
                    element={<ActiveCustomerJobsPageContainer />}
                  />
                  <Route
                  ...
                  <Route
                    ...
                    element={<DraftCustomerOrderPageContainer />}
                  />
                  <Route
                  ...
                  <Route
                    ...
                    element={<ActiveCustomerOrderPageContainer />}
                  />
                  <Route
                ...
                >
                  <Route path="/dashboard/fundi" element={<FundiDashboard />} />
                  <Route
                ...
                >
                  ...
                  <Route
                    ...
                    element={<HardwareQuotationsOrdersPageContainer />}
                  />
                  <Route
                    path="/hardware/active/order/:id"
                    element={<HardwareActiveOrdersPageContainer />}
                  />
                  <Route
                ...
                >
                  ...
                  <Route
                    ...
                    element={<ActiveContractorJobsPageContainer />}
                  />
                  <Route
                    path="/contractor/complete/job/:id"
                    element={<PastContractorJobsPageContainer />}
                  />
                  <Route
                    path="/contractor/draft/job/:id"
                    element={<DraftJobContractorRequestDetails />}
                  />
                  <Route
                    path="/contractor/new/order/:id"
                    element={<NewContractorOrderPageContainer />}
                  />
                  <Route
                  ...
                  <Route
                    ...
                    element={<ContractorBidsOrdersPageContainer />}
                  />
                  <Route
                    path="/contractor/active/order/:id"
                    element={<ContractorActiveOrdersPageContainer />}
                  />
                  <Route
                    path="/contractor/complete/order/:id"
                    element={<PastContractorOrderPageContainer />}
                  />
                </Route>
                {/* */}
                <Route
                  element={
                    <ProtectedRoute
                      allowedRoles={["CONTRACTOR", "PROFESSIONAL", "CUSTOMER"]}
                    />
                  }
                >
                  <Route
                    path="/job-progress/:id/:milestoneId"
                    element={<ProgressComponent />}
                  />
                  <Route
                    path="/bill-details/:id/:billid"
                    element={<BillDetails />}
                  />
                </Route>
                ...
                <Route element={<ProtectedRoute allowedRoles={["ADMIN"]} />}>
                  <Route path="/dashboard/admin" element={<AdminRootLayout />}>
                    <Route
                      index
                      element={React.createElement(
                        React.lazy(
                          () => import("@/pages/dashboard/admin/index"),
                        ),
                      )}
                    />
                    <Route
                    ...
                    <Route
                      ...
                      element={React.createElement(
                        React.lazy(
                          () => import("@/pages/dashboard/admin/jobs"),
                        ),
                      )}
                    />
                    <Route
                      ...
                      element={React.createElement(
                        React.lazy(
                          () => import("@/pages/dashboard/admin/job-detail"),
                        ),
                      )}
                    />
                    <Route
                    ...
                    <Route
                      path="jobs/bid/:id"
                      element={React.createElement(
                        React.lazy(() => import("@/pages/dashboard/admin/bid")),
                      )}
                    />
                    <Route
                      path="jobs/quote/:id"
                      element={React.createElement(
                        React.lazy(
                          () =>
                            import("@/pages/dashboard/admin/quoteBreakdown"),
                        ),
                      )}
                    />
                    <Route
                      ...
                      element={React.createElement(
                        React.lazy(
                          () => import("@/pages/dashboard/admin/orders"),
                        ),
                      )}
                    />
                    <Route
                      ...
                      element={React.createElement(
                        React.lazy(
                          () => import("@/pages/dashboard/admin/order-detail"),
                        ),
                      )}
                    />
                    <Route
                      ...
                      element={React.createElement(
                        React.lazy(
                          () => import("@/pages/dashboard/admin/register"),
                        ),
                      )}
                    />
                    <Route
                    ...
                    />
                    <Route path="shop/regions" element={<ShopRegions />} />
                    <Route path="shop/prices" element={<ShopPrices />} />
                    <Route
                      path="builders"
                      element={React.createElement(
                        React.lazy(
                          () =>
                            import("@/pages/dashboard/admin/registers/builders"),
                        ),
                      )}
                    />
                    <Route
                      ...
                      element={React.createElement(
                        React.lazy(
                          () =>
                            import("@/pages/dashboard/admin/registers/customers"),
                        ),
                      )}
                    />
                  </Route>
